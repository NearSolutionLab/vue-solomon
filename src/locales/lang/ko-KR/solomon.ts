export default {
  ...
  text: {
    ...
    annual_outbound_order_count_trend: '월별 출고 물동량 추이',
    average_daily_inbound_by_day_of_the_week: '요일별 평균 입고량',
    average_daily_outbound_order_quantity_by_day_of_the_week: '요일별 평균 출고 물동량',
    ...
    sku_outbound_status: '상품별 출고현황',
    pay_per_use: '종량제',
    quantity: '수량',
    quarter: '분기',
    quarterly_inbound_quantity: '분기별 입고량',
    quarterly_outbound_order_count: '분기별 출고 물동량',
    rate_plan: '요금제',
  ...
  title: {
    ...
    sign_up: '회원가입',
    sku_diffculty_decrease: '작업난이도 감소율(%)',
    sku_name: 'SKU이름',
    sku_no: 'SKU번호',
    ...
    unit_cbm: '단위: cm3',
    unit_kwon: '단위: 1,000₩',
    unit_kcbm: '단위: 1,000cm3',
    box_recommend: '박스 추천',
    box_type: '박스 타입',
    box_price: '박스 단가',
    box_qty: '박스 수량',
    box_amount: '박스 원가',
    empty_volume: '빈 체적(CBM)',
    empty_volume_ratio: '빈 체적(%)',
    outbound_date: '출고일자',
    job_date: '작업일',
    differential: '차이',
    summary: '계',
